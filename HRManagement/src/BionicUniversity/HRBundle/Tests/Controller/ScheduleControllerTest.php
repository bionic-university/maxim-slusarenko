...
namespace BionicUniversity\HRBundle\Tests\Controller;
...
class ScheduleControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'bionicuniversity_hrbundle_scheduletype[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Edit')->form(array(
            'bionicuniversity_hrbundle_scheduletype[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
