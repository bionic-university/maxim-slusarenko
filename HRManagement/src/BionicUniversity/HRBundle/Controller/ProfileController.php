...
use BionicUniversity\HRBundle\Entity\Profile;
use BionicUniversity\HRBundle\Form\ProfileType;
...
class ProfileController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BionicUniversityHRBundle:Profile')->findAll();

        return $this->render('BionicUniversityHRBundle:Profile:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('BionicUniversityHRBundle:Profile:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BionicUniversityHRBundle:Profile')->find($id);
        ...
        return $this->render('BionicUniversityHRBundle:Profile:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BionicUniversityHRBundle:Profile:edit.html.twig', array(
            'entity'      => $entity,
